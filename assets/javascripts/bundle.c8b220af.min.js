...
` +
  ...
  var Mt = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (o.isStopped = !1),
        r ? ((o.destination = r), zt(r) && r.add(o)) : (o.destination = Yi),
        o
      );
    }
    return (
  ...
  function Gi(e) {
    return (e && e instanceof Mt) || (Bi(e) && zt(e));
  }
  function Ji(e) {
  ...
  var gt = (function (e) {
    ...
    return (
      ...
      (t.prototype.requestAsyncId = function (r, o, n) {
        return (
          n === void 0 && (n = 0), Ct.setInterval(r.flush.bind(r, this), n)
        );
      }),
  ...
  var rt = Kn(Se("header"), { viewport$: Oe }),
    ...
    Es = C(() =>
      O(
        ...
        ...ae("content").map((e) =>
          zn(e, { viewport$: Oe, target$: Ot, print$: _i }),
        ),
        ...ae("content").map((e) =>
        ...
        ...ae("sidebar").map((e) =>
          e.getAttribute("data-md-type") === "navigation"
            ? Nr(Mi, () => Zr(e, { viewport$: Oe, header$: rt, main$: jt }))
            : Nr(hr, () => Zr(e, { viewport$: Oe, header$: rt, main$: jt })),
        ),
